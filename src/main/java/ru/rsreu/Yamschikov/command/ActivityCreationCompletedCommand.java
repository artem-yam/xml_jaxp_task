...
public class ActivityCreationCompletedCommand implements ActionCommand {
	...
	public GoToPageHandler execute(HttpServletRequest request) {
		...
		request.getSession().setAttribute("userAction", "activity create");

		String name = (String) request.getSession().getAttribute("actName");
		String description = (String) request.getSession().getAttribute("actDescription");
		String dateStr = (String) request.getSession().getAttribute("actDate");
		String typeStr = (String) request.getSession().getAttribute("actType");
		...
		case "dissertation":
			...
			Dissertation diss = new Dissertation(0, name, user, type, date, description, 0, organization, degree);
		...
		case "event":
			...
			Event event = new Event(0, name, user, type, date, description, 0, eventType, location, locationType,
					participation);
		...
		case "patent":
			...
			Patent patent = new Patent(0, name, user, type, date, description, 0, patentType, declarant);
		...
		case "publication":
			...
			Publication publication = new Publication(0, name, user, type, date, description, 0, publicationType,
		...
		case "award":
			...
			Award award = new Award(0, name, user, type, date, description, 0, awardType, awardValue);
		...
		scientificActivityDAO.createActivity(activity);
